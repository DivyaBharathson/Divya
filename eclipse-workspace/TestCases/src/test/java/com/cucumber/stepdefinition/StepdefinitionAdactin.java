...
public class StepdefinitionAdactin extends SeleniumBaseClass {
	...
	public void user_launch_Adactin_web_page() throws Throwable {
		...
		File takeScreenShot = takeScreenShot("launchbrowser");
	...
	public void check_page_title_relevance_Login_Page() throws Throwable {
		
		pageTitleRelevance("Hotel Reservation");
	  	}

	@Then("^Check page title relevance - Booking page$")
	public void check_page_title_relevance_Booking_page() throws Throwable {
		
	    pageTitleRelevance("Search Hotel");
	}
	@Then("^Check page title relevance - Payment page$")
	public void check_page_title_relevance_Payment_page() throws Throwable {
		 pageTitleRelevance("Book A Hotel");
	}

	@Then("^Check page title relevance - Itinerary page$")
	public void check_page_title_relevance_Itinerary_page() throws Throwable {
	    System.out.println(driver.getTitle());
	}
	
	@Given("^User click logout button$")
	public void user_click_logout_button() throws Throwable {
	    clickOnTheElement(po.getBookingPage().getLogOut());
	}

	@Then("^User check if account logged out or not$")
	public void user_check_if_account_logged_out_or_not() throws Throwable {
	    if(po.getBookingPage().getVerifyLoggedOut().isDisplayed()) {
	    	System.out.println("Successfully logged out");
	    }else {
	    	System.out.println("Not Logged out yet");
	    }
	}
