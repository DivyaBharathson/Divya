...
public class AdactinBookingPOM extends SeleniumBaseClass {
	...
	@FindBy (xpath="(//td[@class='welcome_menu']//following-sibling::a)[4]")
	private WebElement logOut;
	
	@FindBy (xpath="//td[contains(text(),'logged out')]")
	private WebElement VerifyLoggedOut;
	
	
	public WebElement getVerifyLoggedOut() {
		return VerifyLoggedOut;
	}
