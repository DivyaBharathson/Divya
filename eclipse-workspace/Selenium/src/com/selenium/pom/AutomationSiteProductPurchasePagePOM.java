...
public class AutomationSiteProductPurchasePagePOM extends SeleniumBaseClass{
	...
	public WebElement getToCheckDeliveryDetails() {
		return toCheckDeliveryDetails;
	}

	public void setToCheckDeliveryDetails(WebElement toCheckDeliveryDetails) {
		this.toCheckDeliveryDetails = toCheckDeliveryDetails;
	}

	public WebElement getAgreeTermsAndConditions() {
		return agreeTermsAndConditions;
	}

	public void setAgreeTermsAndConditions(WebElement agreeTermsAndConditions) {
